    ...
    <b-form>
      <div
        ...
        <b-form-group
          ...
          :label="getTranslation('evoker_selector', 'en')"
          label-for="select-evoker">
          <b-form-select
            v-model="selectedChar"
            id="select-evoker"
            :disabled="hasAllEvokers">
            <option
              v-for="char in filteredChars"
              :value="char.id"
              :key="char.id">
              {{getTranslation(char.name, 'en')}}
            </option>
          </b-form-select>
        </b-form-group>
        <b-form-group
          ...
          :label="getTranslation('stage_selector', 'en')"
          label-for="select-stage">
          <b-form-select
